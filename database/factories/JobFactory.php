...
class JobFactory extends Factory
{
    ...
    {
        return [
            // user_id, title, description, salary, tags, job_type, remote, requirements, benefits, address, city, state, zipcode, contact_email, contact_phone, company_name, company_description, company_logo, company_website
