<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action={{ route('jobs.update', $job->id) }} enctype="multipart/form-data">
            ...
            <x-inputs.text id="city" name="city" label="City" placeholder='Quezon City' :value="old('city', $job->city)" />

            <x-inputs.text id="state" name="state" label="State" placeholder='Metro Manila' :value="old('state', $job->state)" />

            <x-inputs.text id="zipcode" name="zipcode" label="Zipcode" placeholder='4107' :value="old('zipcode', $job->zipcode)" />
